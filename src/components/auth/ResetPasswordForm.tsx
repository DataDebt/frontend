...
import { validateResetPasswordFields } from "./auth-form-utils";
...
interface ResetPasswordFormProps {
  ...
  onSubmit: (data: { token: string; newPassword: string }) => Promise<unknown>;
  token: string;
}

export default function ResetPasswordForm({ error, isSubmitting, onSubmit, token }: ResetPasswordFormProps) {
  ...
  async function handleSubmit() {
    const nextErrors = validateResetPasswordFields({ token, password, confirmPassword });
