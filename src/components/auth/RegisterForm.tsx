...
import { validateRegisterFields } from "./auth-form-utils";
...
interface RegisterFormProps {
  ...
  onResendVerification: (data: { email: string }) => Promise<unknown>;
  onSubmit: (data: { username: string; email: string; password: string }) => Promise<unknown>;
